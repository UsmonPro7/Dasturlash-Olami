...
<body>
    <div class="container">
        <form action="" method="POST" class="login-email">
            <p class="login-text" style="font-size: 2em;; font-weight: 800;">Register</p>
            ...
            <!-- <p class="login-register-text">Have an account? <a href="index.php">Login Now</a></p> -->
        </form>
    </div>
</body>
</html>